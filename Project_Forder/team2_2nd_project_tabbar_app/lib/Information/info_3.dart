...
class _Info3State extends State<Info3> {
  ...
  void initState() {
    ...
    swichValue = true;
    jang = [
      "🧠 지능이 뛰어나 새로운 명령이나 트릭을 빠르게 배우고 잘 기억해요.",
      "🤝 충성심이 좋아 주인에게 매우 충실하고 교감이 깊어요.",
      "🎾 운동성에너지가 넘치고 다양한 스포츠나 놀이를 즐겨요.",
      "‍👩‍👧‍👦 사회성이 좋아 다른 동물과도 잘 지내는 편이에요.",
      "‍🐑 양몰이 본능이 살아 있어 훈련 시 집중력이 탁월해요."
    ];
    dan = [
      "🏃 운동량&활동량이 많아 매일 충분한 운동이 필요해요.",
      "😵 지루하면 스트레스를 받고 문제 행동을 보일 수 있어요.",
      "🧽 손질털이 풍성해서 정기적인 빗질과 관리가 필요해요.",
      "‍🧠 도전 욕구가 심하고 너무 똑똑해서 단순한 훈련은 금방 싫증을 느껴요."
    ];
